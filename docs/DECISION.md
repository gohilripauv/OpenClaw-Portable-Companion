...
| Package the official portable Companion | Upstream-signed UI plus a local portable Gateway/runtime | Selected. It preserves the trust boundary, keeps the delta small, and lets this project focus on version pinning, local state, auth, and process lifecycle. |
